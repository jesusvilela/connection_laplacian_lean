...
$\scalarCycleLaplacian\cdot v_k=(2-2\cos(2\pi k/n))\,v_k$
...
\noindent\textit{Acknowledgements.} This work was carried out
within the ``UTAI bunny study'' project on formal verification of
combinatorial spectral identities; ontology and methodology drew
from the pre-registration discipline outlined therein.
